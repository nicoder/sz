...
const results = [
  ...
  },
  {
    ...
    year: 2023,
    category: 'Touriste',
    timeToZinal: '4:50.26,8',
    averageSpeed: '',
    timeToPonchette: '1:35.11,6',
    timeFromPonchetteToChandolin: '36.30,2',
    timeToChandolin: '',
    timeFromChandolinToTignousa: '33.36,7',
    timeFromTignousaToWeisshorn: '40.04,3',
    timeToWeisshorn: '',
    timeFromWeisshornToBarneuza: '51.23,9',
    timeFromBarneuzaToZinal: '33.40,1',
  },
  {
    name: 'Martin D.',
    year: 2023,
    category: 'Touriste',
    timeToZinal: '4:00.16,0',
    averageSpeed: '',
    timeToPonchette: '1:17.53,5',
    timeFromPonchetteToChandolin: '28.10,2',
    timeToChandolin: '',
    timeFromChandolinToTignousa: '28.00,5',
    timeFromTignousaToWeisshorn: '32.31,3',
    timeToWeisshorn: '',
    timeFromWeisshornToBarneuza: '43.07,8',
    timeFromBarneuzaToZinal: '30.32,7',
  },
  {
    name: 'Nicolas',
    year: 2023,
    category: 'Touriste',
    timeToZinal: '3:57.15,9',
    averageSpeed: '',
    timeToPonchette: '1:16.29,0',
    timeFromPonchetteToChandolin: '30.11,5',
    timeToChandolin: '',
    timeFromChandolinToTignousa: '27.37,4',
    timeFromTignousaToWeisshorn: '31.38,1',
    timeToWeisshorn: '',
    timeFromWeisshornToBarneuza: '41.35,2',
    timeFromBarneuzaToZinal: '29.44,7',
  },
];
...
const sources = {
  Touriste: {
    ...
    2023: 'https://www.datasport.com/live/ranking?racenr=25138&kat=21',
  },
  'Touriste (St Antoine)': {
